...
function fjvu_dk_profile_modules() {
  return array(
    ...
    // contrib
    'admin_menu', 'advanced_help', 'calendar', 'calendar_ical', 'content', 'ctools', 'comment_notify', 'date', 'date_locale', 'date_popup', 'date_repeat', 'date_tools', 'emfield', 'fckeditor', 'filefield', 'fieldgroup', 'fivestar', 'flag', 'flag_actions', 'globalredirect', 'googleanalytics', 'imageapi', 'imageapi_gd', 'imagefield', 'imce', 'jquery_ui', 'mass_contact', 'mimedetect', 'nodereference', 'nodewords', 'nodewords_nodetype', 'number', 'pathauto', 'path_redirect', 'scheduler', 'signup', 'similarterms', 'text', 'token', 'transliteration', 'webfm', 'webfm_image', 'webfm_popup', 'views', 'views_ui', 'xmlsitemap'
  );
}
